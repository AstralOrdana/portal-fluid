...
public class LayeredCauldronBlockMixin {
    ...
    @WrapOperation(method = "entityInside", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/Entity;isOnFire()Z"))
    private boolean isOnFireOrHasRifting(Entity instance, Operation<Boolean> original) {
        return original.call(instance) || instance instanceof LivingEntity livingEntity && livingEntity.hasEffect(ModEffects.RIFTING.getHolder());
    }
