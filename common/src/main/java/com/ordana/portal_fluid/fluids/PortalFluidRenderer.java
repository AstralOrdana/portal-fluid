...
public class PortalFluidRenderer extends ModFluidRenderProperties {
    ...
    private static final PortalFluidSpriteSet
        ...
        EAST = createSpriteSet("block/portal_fluid_e"),
        SOUTH = createSpriteSet("block/portal_fluid_s"),
        WEST = createSpriteSet("block/portal_fluid_w"),
        SOUTH_WEST = createSpriteSet("block/portal_fluid_sw"),
        SOUTH_EAST = createSpriteSet("block/portal_fluid_se"),
        NORTH_WEST = createSpriteSet("block/portal_fluid_nw"),
        NORTH_EAST = createSpriteSet("block/portal_fluid_ne"),
        NORTH_SOUTH = createSpriteSet("block/portal_fluid_ns"),
        EAST_WEST = createSpriteSet("block/portal_fluid_ew"),
        WEST_NORTH_EAST = createSpriteSet("block/portal_fluid_wne"),
        NORTH_EAST_SOUTH = createSpriteSet("block/portal_fluid_nes"),
        EAST_SOUTH_WEST = createSpriteSet("block/portal_fluid_esw"),
        SOUTH_WEST_NORTH = createSpriteSet("block/portal_fluid_swn"),
        ALL = createSpriteSet("block/portal_fluid_all"),
        DISCONNECTED = createSpriteSet("block/portal_fluid_disconnected"),
        DISCONNECTED_UNCOMMON = createSpriteSet("block/portal_fluid_disconnected_uncommon"),
    ...
    private boolean isPortalFluid(FluidState state) {
        return state.is(ModTags.PORTAL_FLUID);
    }

    @SuppressWarnings("deprecation")
    private boolean isRandomPos(BlockPos pos, int rarity) {
        long seed = (long) (Mth.getSeed(pos) * ClientConfigs.PORTAL_FLUID_SEED.get());
