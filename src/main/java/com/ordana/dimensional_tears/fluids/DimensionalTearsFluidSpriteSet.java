...
public class DimensionalTearsFluidSpriteSet {
    ...
    public static final Identifier FLOWING = DimensionalTearsRoot.res("block/dimensional_tears_flowing");
    public static final Identifier OVERLAY = DimensionalTearsRoot.res("block/dimensional_tears_overlay");
    public static final Identifier UNDER = DimensionalTearsRoot.res("textures/misc/under_dimensional_tears.png");
    ...
    public DimensionalTearsFluidSpriteSet(Identifier location) {
    ...
    public static FogData renderFog(Entity entity, float viewDistance) {
        var fog = new FogData();
        /*FIMXE
        if (entity.isSpectator()) {
            fog.setShaderFogStart(-8.0F);
            fog.setShaderFogEnd(viewDistance * 0.5F);
        }
        else {
            fog.setShaderFogStart(FOG_START);
            fog.setShaderFogEnd(FOG_END);
        }
